...
p1.images.attach(io:file1, filename: 'images/bolanburg_dining_table/main_D647-32-MOOD-C.webp')
...
p1.images.attach(io:file2, filename: 'images/bolanburg_dining_table/D647-32-TOP-DETAIL.jpeg')
file3 = open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/bolanburg_dining_table/D647-32-MOOD-B.jpeg')
p1.images.attach(io:file3, filename: 'images/bolanburg_dining_table/D647-32-MOOD-B.jpeg')
file4 = open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/bolanburg_dining_table/D647-32-MOOD-A.jpeg')
p1.images.attach(io:file4, filename: 'images/bolanburg_dining_table/D647-32-MOOD-A.jpeg')
...
p1.images.attach(io:file5, filename: 'images/bolanburg_dining_table/D647-32-FRONT-SW-P1-KO.webp')
...
p1.images.attach(io:file6, filename: 'images/bolanburg_dining_table/D647-32-DETAIL-B.webp')
...
p1.images.attach(io:file7, filename: 'images/bolanburg_dining_table/D647-32-DETAIL-A.webp')
...
p1.images.attach(io:file8, filename: 'images/bolanburg_dining_table/D647-32-Bolanburg-DIM.jpeg')
...
p1.images.attach(io:file9, filename: 'images/bolanburg_dining_table/D647-32-10x8-CROP.webp')
...
p1.images.attach(io:file1, filename: 'images/skempton_dining_table/main_D394-113.webp')
...
p1.images.attach(io:file2, filename: 'images/skempton_dining_table/D394-113-SW-P1-KO.webp')
file3 = open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/skempton_dining_table/D394-113-MOOD-V.webp')
p1.images.attach(io:file3, filename: 'images/skempton_dining_table/D394-113-MOOD-V.webp')
file4 = open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/skempton_dining_table/D394-113-MOOD-H.webp')
p1.images.attach(io:file4, filename: 'images/skempton_dining_table/D394-113-MOOD-H.webp')
...
p1.images.attach(io:file5, filename: 'images/skempton_dining_table/D394-113-10X8-CROP.webp')
...
p1.images.attach(io:file1, filename: 'images/havalance_coffee_table/main_T814-1-10X8-CROP.webp')
...
p1.images.attach(io:file2, filename: 'images/havalance_coffee_table/T814-1-Havalance-DIM.webp')
file3 = open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/havalance_coffee_table/T814-1-SW-P1-KO.webp')
p1.images.attach(io:file3, filename: 'images/havalance_coffee_table/T814-1-SW-P1-KO.webp')
file4 = open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/havalance_coffee_table/T814-FINISH-500.webp')
p1.images.attach(io:file4, filename: 'images/havalance_coffee_table/T814-FINISH-500.webp')
...
Weight250 lbs. (113.4 kgs.)', category: "Outdoor Dining Sets", measurement: 'Width: 45.00",Depth: 45.00",Height: 25.50"', color: "Antique White", price: 3149.00  })
...
p1.images.attach(io:file1, filename: 'images/preston_table_set/main_P460-772-821(4)-FIRE.webp')
...
p1.images.attach(io:file2, filename: 'images/preston_table_set/P460-772-821(4)-SW-P1-KO.webp')
...
p1.images.attach(io:file3, filename: 'images/preston_table_set/P460-772-BACK-SW-P1-KO.webp')
...
p1.images.attach(io:file4, filename: 'images/preston_table_set/P460-772-CLSD-ANGLE-SW-P1-KO.webp')
...
p1.images.attach(io:file5, filename: 'images/preston_table_set/P460-821-ANGLE-SW-P1-KO.webp')
...
p1.images.attach(io:file6, filename: 'images/preston_table_set/P460-821-BACK-SW-P1-KO.webp')
...
p1.images.attach(io:file7, filename: 'images/preston_table_set/P460-821-HEAD-ON-SW-P1-KO.webp')
...
p1.images.attach(io:file8, filename: 'images/preston_table_set/P460-821-SIDE-SW-P1-KO.webp')
