require "open-uri"
# p1=Product.create(name:"Belcampo Sofa", description: "The sumptuously comfortable Belcampo sofa makes it easy to camp out in style. Inspired by quality menswear, the linen-weave upholstery naturally works in a rich jute tone. Crisply tailored box cushions and roll arms give the sofa a modern classic shape sure to complement so many aesthetics. Sporting shades of warm terracotta and indigo blue, four decorative pillows add fashionable flair.",highlights:"Corner-blocked frame!Attached back and loose seat cushions!High-resiliency foam cushions wrapped in thick poly fiber!4 decorative pillows included!Polyester upholstery and pillows!Pillows with soft polyfill!Exposed feet with faux wood finish!Excluded from promotional discounts and coupons!Fabric Details Body and One Side Toss Pillows: Polyester (100)%!Oneside Toss Pillows: Polyester (100)%!140 lbs. (63.5 kgs.)",category:"Couch and Sofa", measurement:'Width: 102.00",Depth: 41.00",Height: 40.00"', color:"gray", price:899.00)
p1=Product.create({name:"Belcampo Sofa"}, {description: "The sumptuously comfortable Belcampo sofa makes it easy to camp out in style. Inspired by quality menswear, the linen-weave upholstery naturally works in a rich jute tone. Crisply tailored box cushions and roll arms give the sofa a modern classic shape sure to complement so many aesthetics. Sporting shades of warm terracotta and indigo blue, four decorative pillows add fashionable flair."},{highlights:"Corner-blocked frame!Attached back and loose seat cushions!High-resiliency foam cushions wrapped in thick poly fiber!4 decorative pillows included!Polyester upholstery and pillows!Pillows with soft polyfill!Exposed feet with faux wood finish!Excluded from promotional discounts and coupons!Fabric Details Body and One Side Toss Pillows: Polyester (100)%!Oneside Toss Pillows: Polyester (100)%!140 lbs. (63.5 kgs.)"},{category:"Couch and Sofa"}, {measurement:'Width: 102.00",Depth: 41.00",Height: 40.00"'}, {color:"gray"}, {price:899.00})
...
p1_4=open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/belcampo+sofa/13405-38-35.webp')
p1_5=open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/belcampo+sofa/13405-38-35-T046-ALT.webp')
p1.images.attach(io:p1_0, filename:'main_13405-38-SET.webp')
p1.images.attach(io:p1_1, filename:'1340538-10x8-CROP.png')
p1.images.attach(io:p1_2, filename:'13405-MOOD-A.webp')
p1.images.attach(io:p1_3, filename:'13405-38-SW-P1-KO.webp')
p1.images.attach(io:p1_4, filename:'13405-38-35.webp')
p1.images.attach(io:p1_5, filename:'13405-38-35-T046-ALT.webp')



# p2=Product.create(name: "Abinger Sofa", description: "If you’re looking to lighten the mood, you’re sure to find the space-conscious, budget-conscious Abinger sofa a breath of fresh air. Covered in a cream-tone chenille upholstery loaded with plush texture, this less-is-more contemporary sofa is dressed to impress with angled side profiling and track armrests wrapped with a layer of pillowy softness for that little something extra. Crisp and clean, the 2-over-2 cushion styling adds up to one sensational look.",highlights:"Corner-blocked frame!Attached back and loose seat cushions!High-resiliency foam cushions wrapped in thick poly fiber!Polyester upholstery!2 throw pillows included!Pillows with soft polyfill!Exposed feet with faux wood finish!Fabric Details!Body and One Side Toss Pillows: Polyester (100)!Oneside Toss Pillows: Polyester (100)%!Weight 124 lbs. (56.25 kgs.)", category: "Couch and Sofa", measurement: '"Width: 89.00",Depth: 38.00",Height: 39.00"' ,color: "Natural, Smoke", price: 649.00 )
# p2_1=open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/abinger_sofa/main_8390438-SET-10X8-CROP.png')
# p2.images.attach(io:p2_1, filename: 'main_8390438-SET-10X8-CROP.png')
# p2_2=open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/abinger_sofa/8390438-Abinger-DIM.webp')
# p2.images.attach(io:p2_2, filename: '8390438-Abinger-DIM.webp')
# p2_3=open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/abinger_sofa/83904-SWATCH-BODY-A-500.jpeg')
# p2.images.attach(io:p2_3, filename: '83904-SWATCH-BODY-A-500.jpeg')
# p2_4=open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/abinger_sofa/83904-38-SIDE-SW-P1-KO.webp')
# p2.images.attach(io:p2_4, filename: '83904-38-SIDE-SW-P1-KO.webp')
# p2_5=open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/abinger_sofa/83904-38-HEAD-ON-SW-P1-KO.webp')
# p2.images.attach(io:p2_5, filename: '83904-38-HEAD-ON-SW-P1-KO.webp')
# p2_6=open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/abinger_sofa/83904-38-BACK-SW-P1-KO.webp')
# p2.images.attach(io:p2_6, filename: '83904-38-BACK-SW-P1-KO.webp')
# p2_7=open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/abinger_sofa/83904-38-ANGLE-SW-P1-KO.webp')
# p2.images.attach(io:p2_7, filename: '83904-38-ANGLE-SW-P1-KO.webp')
...
file1 = File.open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/The+Man-Den+Triple+Power+Reclining+Sofa/main-U8530515-SET-10X8-CROP.png')
p5.images.attach(io:file1, filename: 'images/The Man-Den Triple Power Reclining Sofa/main-U8530515-SET-10X8-CROP.png')
file2 = File.open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/The+Man-Den+Triple+Power+Reclining+Sofa/U85305-15-CLSD-ANGLE-SW-P1-KO.webp')
p5.images.attach(io:file2, filename: 'images/The Man-Den Triple Power Reclining Sofa/U85305-15-CLSD-ANGLE-SW-P1-KO.webp')
file3 = File.open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/The+Man-Den+Triple+Power+Reclining+Sofa/U85305-15-CUP-HLDRS.jpeg')
p5.images.attach(io:file3, filename: 'images/The Man-Den Triple Power Reclining Sofa/U85305-15-CUP-HLDRS.jpeg')
file4 = File.open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/The+Man-Den+Triple+Power+Reclining+Sofa/U85305-15-ARM-STORAGE-SW.jpeg')
p5.images.attach(io:file4, filename: 'images/The Man-Den Triple Power Reclining Sofa/U85305-15-ARM-STORAGE-SW.jpeg')
file5 = File.open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/The+Man-Den+Triple+Power+Reclining+Sofa/U85305-15-DDT-LIGHT-SW.webp')
p5.images.attach(io:file5, filename: 'images/The Man-Den Triple Power Reclining Sofa/U85305-15-DDT-LIGHT-SW.webp')
file6 = File.open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/The+Man-Den+Triple+Power+Reclining+Sofa/U85305-15-DETAIL.webp')
p5.images.attach(io:file6, filename: 'images/The Man-Den Triple Power Reclining Sofa/U85305-15-DETAIL.webp')
file7 = File.open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/The+Man-Den+Triple+Power+Reclining+Sofa/AHS_TheManDen_U8530515_PwrRecSofa-AdjHeadrest_P2.jpeg')
...
file8 = File.open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/The+Man-Den+Triple+Power+Reclining+Sofa/U85305-15-OPEN-ANGLE-SW-P1-KO.webp')
p5.images.attach(io:file8, filename: 'images/The Man-Den Triple Power Reclining Sofa/U85305-15-OPEN-ANGLE-SW-P1-KO.webp')
file9 = File.open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/The+Man-Den+Triple+Power+Reclining+Sofa/U85305-15-SIDE-SW-P1-KO.webp')
p5.images.attach(io:file9, filename: 'images/The Man-Den Triple Power Reclining Sofa/U85305-15-SIDE-SW-P1-KO.webp')
file10 = File.open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/The+Man-Den+Triple+Power+Reclining+Sofa/U85305-SWATCH-BODY-A-500.jpeg')
