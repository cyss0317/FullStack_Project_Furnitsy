...
file1 = open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/bunk_bed/main_B106-59-MOOD-B.webp')
p1.images.attach(io:file1, filename: 'images/bunk_bed/main_B106-59-MOOD-B.webp')
file2 = open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/bunk_bed/B106-59-SW-KO.webp')
p1.images.attach(io:file2, filename: 'images/bunk_bed/B106-59-SW-KO.webp')
file3 = open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/bunk_bed/B106-59-MOOD-C.webp')
p1.images.attach(io:file3, filename: 'images/bunk_bed/B106-59-MOOD-C.webp')
file4 = open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/bunk_bed/B106-59-Dinsmore-DIM.webp')
p1.images.attach(io:file4, filename: 'images/bunk_bed/B106-59-Dinsmore-DIM.webp')
file5 = open('https://furnitsy-furniture-images.s3.us-east-2.amazonaws.com/images/bunk_bed/B106-59-Dinsmore-DIM+(1).webp')
p1.images.attach(io:file5, filename: 'images/bunk_bed/B106-59-Dinsmore-DIM (1).webp')
